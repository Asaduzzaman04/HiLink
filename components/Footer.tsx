...
const Footer = () => {
  return (
    <footer className="px-6 lg:px-20 xl:px-32 mx-auto  flex justify-center items-center mb-24">
      <div className="padding-container w-full flex  flex-col gap-14">
          ...
          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
            {FOOTER_LINKS.map((columns) => (
              <FooterColumn key={columns.title} title={columns.title}>
                <ul className="font-normal flex flex-col gap-4 text-gray-30">
